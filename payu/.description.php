...
$payUPublicPath = ($_SERVER['HTTPS'] ? 'https' : 'http' ) . '://' . $_SERVER['HTTP_HOST'] .  '/bitrix/tools';

$IPNDefaultScript = $payUPublicPath . '/payu_ipn.php';
$ResultDefaultScript = $payUPublicPath . '/payu_result_payment.php';
