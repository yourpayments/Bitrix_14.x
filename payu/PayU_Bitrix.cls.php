...
class PayU_Bitrix
{ 
	var $luUrl = "https://secure.ypmn.ru/order/lu.php", $button = "<input type='submit' class='goPayment' value='������� � ������'>", $debug = 0, $showinputs = "hidden", $isWinEncode = false, $encoding = 'windows-1251';
